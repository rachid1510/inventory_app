    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading clearfix">
           <form>
             <input type="text" class="col-md-4 form-control" name="imei" placeholder="IMEI">
             <input type="text" class="col-md-4 form-control" name="ref_order" placeholder="REF COMMANDE">
             <input type="date" class="col-md-4 form-control" name="date_debut" placeholder="DATE ARRIVEE">
           </form>
